...
export default function ExpandableNote({ text }) {
  ...
  return (
    <>
      {text && (
        <div className="text-text_color/70 flex w-full items-start justify-start gap-3 pr-2 sm:pr-4">
          <MessageIcon styles="size-4 shrink-0 mt-1 stroke-text_color/50 fill-text_color/50" />
