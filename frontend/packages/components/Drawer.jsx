...
export function DrawerContent({ styles, ...props }) {
  return (
    <DrawerPrimitive.Portal>
      ...
      >
        <DrawerPrimitive.Popup
          className="bg-layer_bg text-text_color outline-border_color -mb-[3rem]
            max-h-[calc(80vh+3rem)] w-full
            [transform:translateY(var(--drawer-swipe-movement-y))] touch-auto
            overflow-y-auto overscroll-contain rounded-t-2xl px-6 pt-4
