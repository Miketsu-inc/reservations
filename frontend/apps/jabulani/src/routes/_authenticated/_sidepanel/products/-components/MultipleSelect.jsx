...
import { Button, Select } from "@reservations/components";
  ...
  return (
    <div className={`flex flex-col gap-2 ${styles}`}>
      ...
      {selectedItems.length > 0 && (
        <div
          className="mt-1 flex gap-2 overflow-x-auto scroll-smooth rounded-lg
            pb-2 outline-none md:max-h-24 md:flex-wrap md:overflow-y-auto
            dark:scheme-dark"
        >
