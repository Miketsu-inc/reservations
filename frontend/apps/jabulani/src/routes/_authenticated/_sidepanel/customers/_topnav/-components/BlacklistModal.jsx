    ...
    >
      <ResponsiveDialogContent>
        <div className="m-3 sm:w-md md:m-4">
          ...
          <div
            className="text-text_color/80 flex flex-col justify-center gap-4
              py-3 text-center"
          >
            {data?.is_blacklisted ? (
              <p>
              ...
              <p>
                ...
                to create bookings from now on. They will see a message asking
                them to contact you for creating a booking once trying.
              </p>
            )}
            <Textarea
              ...
              labelText={
                data?.is_blacklisted ? "Your Reason for blacklist" : ""
              }
              required={false}
