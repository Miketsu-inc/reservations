  ...
  return (
    <label
      ...
      className={`${styles} group bg-hvr_gray relative flex h-64 w-full
        ...
        border-dashed border-gray-400 transition-all duration-300 ease-in-out
        hover:border-gray-500 dark:border-gray-600 dark:hover:border-gray-400`}
    >
      {preview ? (
        <>
          <img
          ...
          <button
            onClick={clearImage}
            className="absolute top-2 right-2 rounded-full bg-gray-400 p-1
