...
func (r *catalogRepository) NewService(ctx context.Context, serv domain.Service, servPhases []domain.ServicePhase, ConnProducts []domain.ConnectedProducts) error {
...
func (r *catalogRepository) GetServiceWithPhasesById(ctx context.Context, serviceID int, merchantId uuid.UUID) (domain.PublicServiceWithPhases, error) {
	query := `
...
func (r *catalogRepository) GetServicesByMerchantId(ctx context.Context, merchantId uuid.UUID) ([]domain.ServicesGroupedByCategory, error) {
	query := `
	with services as (
...
func (r *catalogRepository) DeleteServiceById(ctx context.Context, merchantId uuid.UUID, serviceId int) error {
	tx, err := r.db.Begin(ctx)
	if err != nil {
		return err
	}
	...
	_, err = r.db.Exec(ctx, deleteServiceQuery, time.Now().UTC(), merchantId, serviceId)
	if err != nil {
		return err
	}
	...
	_, err = r.db.Exec(ctx, deletePhasesQuery, serviceId, time.Now().UTC())
	if err != nil {
		return err
	}
...
func (r *catalogRepository) UpdateServiceWithPhaseseById(ctx context.Context, pswp domain.ServiceWithPhasesAndSettings) error {
	tx, err := r.db.Begin(ctx)
	if err != nil {
		return err
	}
	...
	var psp domain.PublicServicePhase
...
func (r *catalogRepository) UpdateServiceCategoryById(ctx context.Context, merchantId uuid.UUID, sc domain.ServiceCategory) error {
	query := `
...
func (r *catalogRepository) DeleteServiceCategoryById(ctx context.Context, merchantId uuid.UUID, categoryId int) error {
	query := `
...
func (r *catalogRepository) DeactivateServiceById(ctx context.Context, merchantId uuid.UUID, serviceId int) error {
	query := `
	update "Service"
	set is_active = true
	where id = $1 and merchant_id = $2
...
func (r *catalogRepository) ActivateServiceById(ctx context.Context, merchantId uuid.UUID, serviceId int) error {
	query := `
	update "Service"
	set is_active = false
	where id = $1 and merchant_id = $2
...
func (r *catalogRepository) UpdateConnectedProducts(ctx context.Context, serviceId int, productData []domain.ConnectedProducts) error {
	...
	existingConnectionsMap := map[int]domain.ConnectedProducts{}

	var conn domain.ConnectedProducts
	...
	updatedConnectionsMap := map[int]domain.ConnectedProducts{}
...
func (r *catalogRepository) GetServicesForCalendarByMerchant(ctx context.Context, merchantId uuid.UUID) ([]domain.ServicesGroupedByCategoriesForCalendar, error) {
	query := `
...
func (r *catalogRepository) UpdateGroupServiceById(ctx context.Context, serv domain.GroupServiceWithSettings) error {
	tx, err := r.db.Begin(ctx)
	if err != nil {
		return err
	}
